...
const loadingSteps = [
  "Yorumlar YouTube'dan çekiliyor...",
  "Spam ve anlamsız yorumlar ayıklanıyor...",
...
export default function LoadingState({ message }: { message?: string }) {
  ...
  return (
    <div className="bg-bg-surface border border-border-subtle rounded-md p-6 sm:p-10 text-center w-full max-w-lg mx-auto my-6 sm:my-12 shadow-2xl overflow-hidden">
      ...
      <div className="font-display text-accent-record font-bold text-sm uppercase tracking-widest mb-3 flex items-center justify-center gap-2">
      ...
      <div className="w-full bg-bg-base h-1.5 rounded-full overflow-hidden mt-6 sm:mt-8">
        <div
          className="bg-accent-record h-full transition-all duration-1000 ease-out"
